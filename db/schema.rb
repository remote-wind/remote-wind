...
ActiveRecord::Schema.define(version: 20170611175336) do
  ...
  add_index "latest_observations", ["station_id"], name: "index_latest_observations_on_station_id", using: :btree
  ...
  add_index "observations", ["id", "created_at"], name: "id_created_at", order: {"created_at"=>:desc}, using: :btree
  ...
  add_foreign_key "latest_observations", "stations"
end
